...
public class HttpPost_sign {
    public static boolean  sendText(String name,String mobile,String email,String password)
    {
       // int k;
       //String s=new String();
...
//                .build();
        ...
        String url="http://8.140.3.158:81/user/sign";
