...
public class HttpGet {
    public static  List<Museum> getText(String city,String keyword) {
        MuseumRootBean res=null;
        try {
            // URL url = new URL("http://openapi.tuling123.com/openapi/api/v2" );
            //URL url = new URL(https://api.ownthink.com/bot")
            String u = "http://8.140.3.158:81/museum/show/"+ URLEncoder.encode(city,"utf-8")+"/"+URLEncoder.encode(keyword,"utf-8");//keyword是查询关键字
            URL url = new URL(u);
            ...
            res = gson.fromJson(buffer.toString(), MuseumRootBean.class);
