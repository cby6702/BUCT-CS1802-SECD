...
public class HttpGet_Exhibition {
    ...
    public static  String getText(String ename) {
        try {
            ...
            Exhibition res = gson.fromJson(buffer.toString(), Exhibition.class);

            return res.getEname();//返回名字 同理可以返回对象后使用getName..等方法获得别的信息 然后放到布局文件就可以了
