...
public class MybatisCodeGenerator {
    ...
    private static final String schemaName = "museum";   // 数据库名称，必填
    private static final String[] table = {"collection", "Collection"};   // 必填，第一个是表名，第二个是实体类的名字
    private static final String modelName = "藏品";   // 必填

    //=========================================以上内容必填===================================================//

    static {
        // 必填
        ds.setUrl("jdbc:mysql://8.140.3.158:3306/" + schemaName + "?useUnicode=true&characterEncoding=utf-8&allowMultiQueries=true&useSSL=false&serverTimezone=GMT%2b8");
        ds.setUsername("buctcs1802");
        ds.setPassword("cs1802..");
    }
